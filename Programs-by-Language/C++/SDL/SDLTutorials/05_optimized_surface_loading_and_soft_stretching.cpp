...
bool LoadMedia()
{
	...
	gKeyPressSurfaces[ KEY_PRESS_SURFACE_DEFAULT ] = loadSurface( "VENUS.BMP");
	if( gKeyPressSurfaces[ KEY_PRESS_SURFACE_DEFAULT ] == NULL)
	{
		printf( "Failed to load image %s! SDL Error: %s", "press.bmp", SDL_GetError() );
		success = false;
	}
	...
	{
		printf( "Failed to load image %s! SDL Error: %s", "up.bmp", SDL_GetError() );
		success = false;
	}
	...
	{
		printf( "Failed to load image %s! SDL Error: %s", "down.bmp", SDL_GetError() );
		success = false;
	}
	...
	{
		printf( "Failed to load image %s! SDL Error: %s", "left.bmp", SDL_GetError() );
		success = false;
	}
	...
	{
		printf( "Failed to load image %s! SDL Error: %s", "right.bmp", SDL_GetError() );
		success = false;
	}
...
SDL_Surface* loadSurface( std::string path )
{
	...
	else
	{
		...
		{
			printf( "Failed to optimize image %s! SDL Error: %s", path.c_str(), SDL_GetError() );
		}
